...
<body>
	<table border="0" width="900px">
		<tr>
			<td style="font-size:24px; color:#666" align="center">部门管理</td>
		</tr>
		<tr>
			<td align="right"><a href="${pageContext.request.contextPath}/department_saveUI.action">添加</a>
			</td>
		</tr>
	</table>
	<br/>
	<table cellspacing="0" border="1" class="table1">
		...
		<s:iterator value="list" var="d">
			<tr class="tabtd2">
				...
				<td width="20%" align="center">
					<a href="${pageContext.request.contextPath}/department_delete.action?did=<s:property value="#d.did" />" onclick="return del();">删除</a>
				</td>
			</tr>
		</s:iterator>
	</table>
